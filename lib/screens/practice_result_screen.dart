...
class _PracticeResultScreenState extends State<PracticeResultScreen> with SingleTickerProviderStateMixin {
  ...
  void _shareResults(String nickname) {
    final msg = 'Hey! I just completed a ${widget.courseCode} Practice Session on WAEC CBT.\n'
      ...
      pw.Page(
        ...
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            pw.Row(
              ...
              children: [
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text('WAEC CBT - Practice Result', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 20, color: PdfColors.indigo700)),
                    pw.SizedBox(height: 4),
                    pw.Text('Powered by WAEC CBT', style: pw.TextStyle(fontSize: 10, color: PdfColors.grey600)),
                  ],
                ),
                pw.Column(
            ...
            pw.Center(
              child: pw.Text(
                'Generated by WAEC CBT - ${dateStr} ${timeStr}',
