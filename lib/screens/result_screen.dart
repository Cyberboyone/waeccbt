...
class _ResultScreenState extends State<ResultScreen> with SingleTickerProviderStateMixin {
  ...
  void _shareResults(String nickname) {
    final msg = 'Hey! I just completed the ${widget.courseCode} Exam Simulation on WAEC CBT.\n'
            ...
            pw.Row(
              ...
              children: [
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text('WAEC CBT - Exam Result', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 20, color: PdfColors.indigo700)),
